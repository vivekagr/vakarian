nav_menu = [
    ...
    { 'title': 'UI Elements', 'icon': 'ion-lightbulb', 'children': [
        ...
        { 'title': 'Components', 'template': 'components.html' },
        { 'title': 'Panels', 'template': 'panels.html' },
        { 'title': 'Alerts', 'template': 'alerts.html' },
        { 'title': 'Progress Bars', 'template': 'progress-bars.html' },
    ...
    { 'title': 'Charts', 'icon': 'ion-stats-bars', 'children': [
        ...
        { 'title': 'Flotr2', 'template': 'charts-flotr2.html' },
    ...
    { 'title': 'Forms', 'icon': 'ion-ios7-compose-outline', 'children': [
        { 'title': 'Elements', 'template': 'form-elements.html' },
