$(function() {
    ...
    // All the country codes and countries
    var countries = [
    ...
    // Adding countries to the country select field
...
//        trigger: 'change',
        ...
        fields: {
            ...
            'street': { message: 'Please enter your street address' },
            'city': { message: 'Please enter your city' },
            'zip': { message: 'Please enter your ZIP code' },
        }
    });
